const { EVENT_UPDATE_CONTEST, EVENT_CREATE_SUPERVISOR, EVENT_DELETE_SUPERVISOR, EVENT_LOGIN_SUPERVISOR,
  ...
  EVENT_CREATE_TEAM_TASK_HIT, EVENT_CREATE_TEAM_TASK_HIT_ATTEMPT, EVENT_CREATE_TEAM_TASK_REVIEW, EVENT_CREATE_REMOTE_CHECKER,
  EVENT_UPDATE_REMOTE_CHECKER, EVENT_DELETE_REMOTE_CHECKER, EVENT_CREATE_TASK_REMOTE_CHECKER } = require('./constants')
