...
class TelegramController {
  constructor () {
    ...
    this.socks5 = process.env.hasOwnProperty('TELEGRAM_SOCKS5_HOST') && process.env.TELEGRAM_SOCKS5_HOST !== '' && process.env.hasOwnProperty('TELEGRAM_SOCKS5_PORT') && process.env.TELEGRAM_SOCKS5_PORT !== ''
    if (this.socks5) {
      this.socks5Options = {
        socksHost: process.env.TELEGRAM_SOCKS5_HOST,
        socksPort: parseInt(process.env.TELEGRAM_SOCKS5_PORT, 10)
      }
      if (process.env.hasOwnProperty('TELEGRAM_SOCKS5_USERNAME') && process.env.TELEGRAM_SOCKS5_USERNAME !== '' && process.env.hasOwnProperty('TELEGRAM_SOCKS5_PASSWORD') && process.env.TELEGRAM_SOCKS5_PASSWORD !== '') {
